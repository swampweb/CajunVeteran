...
-- Run in Supabase SQL editor so Active/Inactive, grams, spools, and low threshold save online.
...
where status is null or estimated_grams is null or spools is null or low_grams is null;
